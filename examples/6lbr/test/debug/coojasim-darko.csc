...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>6lowpan-nd nodes</description>
      <source EXPORT="discard">/opt/contiki/contiki-darko/examples/6lowpan-nd-rpl/6lowpan-nd-host.c</source>
      <commands EXPORT="discard" />
      <firmware EXPORT="copy">/opt/contiki/contiki-darko/examples/6lowpan-nd-rpl/6lowpan-nd-host.z1</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <motetype>
      ...
      <description>6lowpan-nd router</description>
      <source EXPORT="discard">/opt/contiki/contiki-darko/examples/6lowpan-nd-rpl/6lowpan-nd-router.c</source>
      <commands EXPORT="discard" />
      <firmware EXPORT="copy">/opt/contiki/contiki-darko/examples/6lowpan-nd-rpl/6lowpan-nd-router.z1</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>48.43055555555554</x>
        <y>15.319444444444446</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
