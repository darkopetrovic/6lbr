...
<simconf>
  ...
  <simulation>
    <title>Debug Custom RDC with 6lowpan-nd and RPL (wismote).</title>
    ...
    <motetype>
      ...
      <description>6lowpan-nd hosts</description>
      <source EXPORT="discard">/opt/contiki/contiki-darko/examples/smart-ipv6-sensor/6lowpan-nd-rpl/6lowpan-nd-rpl.c</source>
      <commands EXPORT="discard" />
      <firmware EXPORT="copy">/opt/contiki/contiki-darko/examples/smart-ipv6-sensor/6lowpan-nd-rpl/6lowpan-nd-rpl-host.wismote</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <motetype>
      ...
      <description>6lowpan-nd routers</description>
      <source EXPORT="discard">/opt/contiki/contiki-darko/examples/smart-ipv6-sensor/6lowpan-nd-rpl/6lowpan-nd-rpl.c</source>
      <commands EXPORT="discard" />
      <firmware EXPORT="copy">/opt/contiki/contiki-darko/examples/smart-ipv6-sensor/6lowpan-nd-rpl/6lowpan-nd-rpl-router.wismote</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>32.13623240756337</x>
        <y>-12.75953742401191</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.1728099151057894 0.0 0.0 2.1728099151057894 130.2557962827803 254.99677669978377</viewport>
    </plugin_config>
    <width>462</width>
    <z>0</z>
    <height>400</height>
